...
enum class Motion : uint8_t {
    ...
    G73                = 73,   // Chip-breaking peck cycle
    None               = 80,   // G80 (Do not alter value)
    G81                = 81,   // G81 canned cycle - drilling
    G82                = 82,   // G82 canned cycle - drilling with dwell
    G83                = 83,   // G83 canned cycle - peck drilling
...
typedef struct {
    ...
    // Canned cycle modal parameters
    float canned_r;  // Canned cycle R value
    float canned_z;  // Canned cycle Z value
    float canned_q;  // Canned cycle Q value
    float canned_p;  // Canned cycle P value
} parser_state_t;
