...
// disable (or enable) steppers via ROTARY_DISABLE_PIN
bool get_rotary_disable();  // returns the state of the pin

// disable (or enable) axis oiler via LUBRICATION_DISABLE_PIN
bool get_lubrication_disable();  // returns the state of the pin
